            ...
            try
            {
                ...
                if (isConnected)
                {
                    ...
                    if (runningContainer.ContainerType==3)
                    {
                        ...
                        if (M65111Result.Content == false && M654Result.Content == false && M900Result.Content == false)
                        {
        ...
        public DataResult StartRestoreContainer(Command.RunningContainer runningContainer)
        {
            ...
            if (isConnected)
            {
                if (runningContainer.ContainerType == 3)
                {
                    ...
                    if (M651Result.Content == false && M654Result.Content == false && M900Result.Content == false)
                    {
                        // 条件满足后执行的代码
